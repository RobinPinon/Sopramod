...
public class SopramodItemTagProvider extends ItemTagProvider{
    public SopramodItemTagProvider(FabricDataOutput output, CompletableFuture<Provider> completableFuture, BlockTagProvider blockTagProvider) {
