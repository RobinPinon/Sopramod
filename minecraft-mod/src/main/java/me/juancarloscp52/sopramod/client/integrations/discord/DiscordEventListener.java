...
public class DiscordEventListener extends ListenerAdapter {
    ...
    public void onReady(@NotNull ReadyEvent event) {
        if(SopramodClient.getInstance().integrationsSettings.discord.channel!=-1){
            discordIntegration.channel= discordIntegration.jda.getTextChannelById(SopramodClient.getInstance().integrationsSettings.discord.channel);
        }
    }
    ...
    public void onMessageReceived(@NotNull MessageReceivedEvent event) {
        ...
        if (msg.getContentRaw().equals("!sopramod join")){
