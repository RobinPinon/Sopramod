...
package com.poc.sopramod.client.Screens.Widgets;
...
public class SopramodEventListWidget extends ContainerObjectSelectionList<SopramodEventListWidget.ButtonEntry> {
    private final List<EventInfo> eventInfos;
    private final Font textRenderer;

    public SopramodEventListWidget(Minecraft minecraftClient, int width, int height, int x, int y, int itemHeight) {
    ...
    public Stream<ButtonEntry> getEntries() {
        return eventInfos.stream().map(eventInfo -> SopramodEventListWidget.ButtonEntry.create(eventInfo, textRenderer));
    }
    ...
    public static class ButtonEntry extends ContainerObjectSelectionList.Entry<SopramodEventListWidget.ButtonEntry> {
        private static final Identifier ICON_OVERLAY_LOCATION = Identifier.withDefaultNamespace("world_list/warning_highlighted");
        private static final Tooltip ACCESSIBILITY_TOOLTIP = Tooltip.create(Component.translatable("sopramod.options.accessibilityMode.eventDisabled"));
        ...
        public static SopramodEventListWidget.ButtonEntry create(EventInfo eventInfo, Font textRenderer) {
            ...
            return new SopramodEventListWidget.ButtonEntry(eventInfo, checkbox);
        }

        private static boolean isEventDisabledInSettings(Holder.Reference<EventType<?>> typeReference) {
            return Sopramod.getInstance().settings.disabledEventTypes
                .stream()
    ...
    public static enum FilterMode {
        ALL("sopramod.options.all"),
        ENABLED("sopramod.options.enabled"),
        DISABLED("sopramod.options.disabled");
