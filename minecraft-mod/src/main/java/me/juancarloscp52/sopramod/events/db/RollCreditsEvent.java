...
import com.poc.sopramod.client.Screens.SopramodCreditsScreen;
...
public class RollCreditsEvent extends AbstractTimedEvent {
    ...
    public void initClient() {
        ...
        client.setScreen(new SopramodCreditsScreen(this));
    }
    ...
    public void endClient() {
        client = Minecraft.getInstance();
        if (client.screen instanceof SopramodCreditsScreen) {
