...
public class NightVisionEvent extends AbstractInstantEvent {
    ...
    @Override
    public void init() {
        Sopramod.getInstance().eventHandler.getActivePlayers().forEach(serverPlayerEntity -> serverPlayerEntity.addEffect(new MobEffectInstance(MobEffects.NIGHT_VISION, (int) (Sopramod.getInstance().settings.baseEventDuration*1.5))));
    }
