...
public class FatigueEvent extends AbstractInstantEvent {
    ...
    @Override
    public void init() {
        Sopramod.getInstance().eventHandler.getActivePlayers().forEach(serverPlayerEntity -> serverPlayerEntity.addEffect(new MobEffectInstance(MobEffects.MINING_FATIGUE, (int) (Sopramod.getInstance().settings.baseEventDuration*1.25),1)));
    }
