...
public class SopramodSliderWidget extends AbstractSliderButton {
    ...
    public SopramodSliderWidget(int x, int y, int width, int height, String translationKey, double value, double min, double max, ValueFormatter formatter, ValueUpdater valueUpdater) {
