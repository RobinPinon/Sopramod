...
public class ResistanceEvent extends AbstractInstantEvent {
    ...
    @Override
    public void init() {
        Sopramod.getInstance().eventHandler.getActivePlayers().forEach(serverPlayerEntity -> serverPlayerEntity.addEffect(new MobEffectInstance(MobEffects.RESISTANCE, (int) (Sopramod.getInstance().settings.baseEventDuration*1.75),3)));
    }
