...
import com.poc.sopramod.events.db.AngryDogsEvent;
import com.poc.sopramod.events.db.AdventureEvent;
import com.poc.sopramod.events.db.ArrowRainEvent;
import com.poc.sopramod.events.db.BigChickenEvent;
...
import com.poc.sopramod.events.db.FarmerTouchEvent;
...
import com.poc.sopramod.events.db.TeleportRandomDimensionEvent;
...
public class EventRegistry {
    ...
    private static Registry<EventType<?>> bootstrap() {
        ...
        register(registry, "angry_dogs", AngryDogsEvent.TYPE);
        register(registry, "arrow_rain", ArrowRainEvent.TYPE);
        register(registry, "big_chicken", BigChickenEvent.TYPE);
        ...
        register(registry, "farmer_touch", FarmerTouchEvent.TYPE);
        ...
        register(registry, "teleport_random_dimension", TeleportRandomDimensionEvent.TYPE);
