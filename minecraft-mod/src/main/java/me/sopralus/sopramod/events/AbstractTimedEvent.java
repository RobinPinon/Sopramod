...
import com.poc.sopramod.networking.ClientboundEndEvent;
...
public abstract class AbstractTimedEvent implements Event {
    ...
    public void tick() {
        ...
        if (tickCount >= this.getDuration()) {
            List<Event> currentEvents = Sopramod.getInstance().eventHandler.currentEvents;
    ...
    public short getDuration() {
        return Sopramod.getInstance().settings.baseEventDuration;
    }
}
