...
public class SopramodBlockTagProvider extends BlockTagProvider {
    public SopramodBlockTagProvider(FabricDataOutput output, CompletableFuture<Provider> completableFuture) {
